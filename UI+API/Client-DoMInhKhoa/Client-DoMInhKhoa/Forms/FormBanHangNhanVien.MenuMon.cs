...
namespace Client_DoMInhKhoa.Forms
{
    public partial class FormBanHangNhanVien
    {
        ...
        private void BuildMenuSearch()
        {
            ...
            {
                Name = "lblTimMon",                 // ✅ để Layout.cs tìm & reflow
                AutoSize = true,
                Text = "Tìm món:",
            ...
            {
                // ✅ UI: chỉ tính theo panel hiện tại (Layout.cs sẽ reflow vị trí Y)
                int rightPadding = 15;
                int newWidth = parent.ClientSize.Width - 90 - rightPadding;
